...
#include "Zenith/Serialization/StreamWriter.hpp"
#include "Zenith/Serialization/StreamReader.hpp"

#include "Zenith/Reflection/TypeDescriptor.hpp"
#include "Zenith/Core/Identifier.hpp"
...
/**  Non-intrusive Binary / Memory Serialization Interface.
	...
	namespace Zenith::Spatialization::Impl
	{
		template<>
...
struct Zenith::Type::Description<Class> : Zenith::Type::MemberList<__VA_ARGS__> {};\

namespace Zenith::Serialization
{
	//=============================================================================
	/// Serialization
	...
	namespace Impl
	{
		...
		*/
		...
		template<>
		ZN_EXPLICIT_STATIC inline bool SerializeImpl(StreamWriter* writer, const UUID& v)
		{
		...
		template<>
		ZN_EXPLICIT_STATIC inline bool SerializeImpl(StreamWriter* writer, const Identifier& v)
		{
		...
		template<>
		ZN_EXPLICIT_STATIC inline bool SerializeImpl(StreamWriter* writer, const std::string& v)
		{
		...
		//=============================================================================
		template<typename T>
		ZN_EXPLICIT_STATIC bool SerializeVec(StreamWriter* writer, const std::vector<T>& vec)
		{
			//if (writeSize)
		...
		//=============================================================================
		template<typename T>
		ZN_EXPLICIT_STATIC bool SerializeByType(StreamWriter* writer, const T& v)
		{
	...
	namespace Impl
	{
		...
		*/
		...
		template<>
		ZN_EXPLICIT_STATIC inline bool DeserializeImpl(StreamReader* reader, UUID& v)
		{
		...
		template<>
		ZN_EXPLICIT_STATIC inline bool DeserializeImpl(StreamReader* reader, Identifier& v)
		{
			uint32_t data;
			reader->ReadRaw(data);
			v = data;
		...
		template<>
		ZN_EXPLICIT_STATIC inline bool DeserializeImpl(StreamReader* reader, std::string& v)
		{
			reader->ReadString(v);
			return true;
		}
		...
		//=============================================================================
		template<typename T>
		ZN_EXPLICIT_STATIC bool DeserializeVec(StreamReader* reader, std::vector<T>&vec)
		{
			uint32_t size = 0;
			//if (size == 0)
		...
		//=============================================================================
		template<typename T>
		ZN_EXPLICIT_STATIC bool DeserializeByType(StreamReader* reader, T& v)
		{
			if constexpr (Type::Described<T>::value)
			{
				return Type::Description<T>::Apply(
