...
struct Zenith::Type::Description<Class, Tag> : Zenith::Type::MemberList<__VA_ARGS__>, Zenith::Type::DescriptionInterface<Zenith::Type::Description<Class,Tag>, Class, Tag, Zenith::Type::MemberList<__VA_ARGS__>>	\
{																		\
private:																\
...
public:																	\
	...
	static constexpr std::array<std::string_view, NumberOfMembers> MemberNames										\
		= Zenith::Utils::RemoveNamespace<NumberOfMembers>(																	\
			Zenith::Utils::SplitString<NumberOfMembers>(MemberStr, Delimiter));												\
};
#endif // !DESCRIBED


#ifndef DESCRIBED
#define DESCRIBED(Class, ...) DESCRIBED_TAGGED(Class, Zenith::Type::TDummyTag, __VA_ARGS__)
#endif
