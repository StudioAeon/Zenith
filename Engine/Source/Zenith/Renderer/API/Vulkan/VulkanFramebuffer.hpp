...
namespace Zenith {
	...
	public:
		...
		virtual Ref<Image2D> GetImage(uint32_t attachmentIndex = 0) const override { ZN_CORE_ASSERT(attachmentIndex < m_AttachmentImages.size()); return m_AttachmentImages[attachmentIndex]; }
