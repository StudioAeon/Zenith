...
namespace Zenith {
	...
	// NOTE(Robert): StringType is used because on non-MSVC compilers we have to make a copy of the buffer we get back from abi::__cxa_demangle
