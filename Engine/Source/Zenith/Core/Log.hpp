...
namespace Zenith {
	...
	// Core logging
	#define ZN_CORE_TRACE_TAG(tag, ...)                                            \
		::Zenith::Log::PrintMessageTag(::Zenith::Log::Type::Core,                    \
																	 ::Zenith::Log::Level::Trace, tag,             \
																	 __VA_ARGS__)
	#define ZN_CORE_INFO_TAG(tag, ...)                                             \
		::Zenith::Log::PrintMessageTag(::Zenith::Log::Type::Core,                    \
																	 ::Zenith::Log::Level::Info, tag, __VA_ARGS__)
	#define ZN_CORE_WARN_TAG(tag, ...)                                             \
		::Zenith::Log::PrintMessageTag(::Zenith::Log::Type::Core,                    \
																	 ::Zenith::Log::Level::Warn, tag, __VA_ARGS__)
	#define ZN_CORE_ERROR_TAG(tag, ...)                                            \
		::Zenith::Log::PrintMessageTag(::Zenith::Log::Type::Core,                    \
																	 ::Zenith::Log::Level::Error, tag,             \
																	 __VA_ARGS__)
	#define ZN_CORE_FATAL_TAG(tag, ...)                                            \
		::Zenith::Log::PrintMessageTag(::Zenith::Log::Type::Core,                    \
																	 ::Zenith::Log::Level::Fatal, tag,             \
																	 __VA_ARGS__)

	// Client logging
	#define ZN_TRACE_TAG(tag, ...)                                                 \
		::Zenith::Log::PrintMessageTag(::Zenith::Log::Type::Client,                  \
																	 ::Zenith::Log::Level::Trace, tag,             \
																	 __VA_ARGS__)
	#define ZN_INFO_TAG(tag, ...)                                                  \
		::Zenith::Log::PrintMessageTag(::Zenith::Log::Type::Client,                  \
																	 ::Zenith::Log::Level::Info, tag, __VA_ARGS__)
	#define ZN_WARN_TAG(tag, ...)                                                  \
		::Zenith::Log::PrintMessageTag(::Zenith::Log::Type::Client,                  \
																	 ::Zenith::Log::Level::Warn, tag, __VA_ARGS__)
	#define ZN_ERROR_TAG(tag, ...)                                                 \
		::Zenith::Log::PrintMessageTag(::Zenith::Log::Type::Client,                  \
																	 ::Zenith::Log::Level::Error, tag,             \
																	 __VA_ARGS__)
	#define ZN_FATAL_TAG(tag, ...)                                                 \
		::Zenith::Log::PrintMessageTag(::Zenith::Log::Type::Client,                  \
																	 ::Zenith::Log::Level::Fatal, tag,             \
																	 __VA_ARGS__)
	...
	#define ZN_CORE_TRACE(...)                                                     \
		::Zenith::Log::PrintMessage(::Zenith::Log::Type::Core,                       \
																::Zenith::Log::Level::Trace, __VA_ARGS__)
	#define ZN_CORE_INFO(...)                                                      \
		::Zenith::Log::PrintMessage(::Zenith::Log::Type::Core,                       \
																::Zenith::Log::Level::Info, __VA_ARGS__)
	#define ZN_CORE_WARN(...)                                                      \
		::Zenith::Log::PrintMessage(::Zenith::Log::Type::Core,                       \
																::Zenith::Log::Level::Warn, __VA_ARGS__)
	#define ZN_CORE_ERROR(...)                                                     \
		::Zenith::Log::PrintMessage(::Zenith::Log::Type::Core,                       \
																::Zenith::Log::Level::Error, __VA_ARGS__)
	#define ZN_CORE_FATAL(...)                                                     \
		::Zenith::Log::PrintMessage(::Zenith::Log::Type::Core,                       \
																::Zenith::Log::Level::Fatal, __VA_ARGS__)

	// Client Logging
	#define ZN_TRACE(...)                                                          \
		::Zenith::Log::PrintMessage(::Zenith::Log::Type::Client,                     \
																::Zenith::Log::Level::Trace, __VA_ARGS__)
	#define ZN_INFO(...)                                                           \
		::Zenith::Log::PrintMessage(::Zenith::Log::Type::Client,                     \
																::Zenith::Log::Level::Info, __VA_ARGS__)
	...
	#define ZN_CONSOLE_LOG_TRACE(...)                                              \
		Zenith::Log::GetEditorConsoleLogger()->trace(__VA_ARGS__)
	#define ZN_CONSOLE_LOG_INFO(...)                                               \
		Zenith::Log::GetEditorConsoleLogger()->info(__VA_ARGS__)
	#define ZN_CONSOLE_LOG_WARN(...)                                               \
		Zenith::Log::GetEditorConsoleLogger()->warn(__VA_ARGS__)
	#define ZN_CONSOLE_LOG_ERROR(...)                                              \
		Zenith::Log::GetEditorConsoleLogger()->error(__VA_ARGS__)
	#define ZN_CONSOLE_LOG_FATAL(...)                                              \
		Zenith::Log::GetEditorConsoleLogger()->critical(__VA_ARGS__)
